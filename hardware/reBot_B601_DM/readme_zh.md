...
> ⚠️ **关于下方实拍图**：电源组装实拍图（`Assembly_Steps/powerstep_images/`，约 94MB）体积过大，**本 fork 未上传到 GitHub**，因此在线浏览本页时下方表格的实拍图会显示为缺失。
> - 本地 clone 中这些图已保留，可正常查看。
> - 在线查看请移步官方上游仓库 [Seeed-Projects/reBot-DevArm](https://github.com/Seeed-Projects/reBot-DevArm) 的对应目录。
> - STEP 打印件、外购件参考图、组装文字步骤均完整保留。
