...
> ⚠️ **About the photos below**: The power supply assembly photos (`Assembly_Steps/powerstep_images/`, ~42MB) are too large and are **not uploaded to GitHub by this fork**, so they will appear missing when browsing this page online.
> - They are kept in the local clone and can be viewed normally.
> - To view online, please refer to the corresponding directory in the official upstream repository [Seeed-Projects/reBot-DevArm](https://github.com/Seeed-Projects/reBot-DevArm).
