...
| 文件夹 | 来源 | 说明 |
|--------|------|------|
| **SoArm_in_Lerobot** | [链接](https://wiki.seeedstudio.com/lerobot_so100m_new/) | SO100 机械臂 LeRobot 教程（项目路线图中 LeRobot 适配参考） |
| **Starai_Arm_in_ROS2_MoveIt** | [链接](https://wiki.seeedstudio.com/starai_arm_ros_moveit/) | StarAI 机械臂 ROS2 MoveIt2 教程（项目路线图中 MoveIt2 适配参考） |
| **Install_the_ROS2_Humble** | [链接](https://wiki.seeedstudio.com/install_ros2_humble/) | ROS2 Humble 安装教程 |
| **Robotics** | [链接](https://wiki.seeedstudio.com/robotics_page/) | Seeed Studio 机器人资源总索引 |
