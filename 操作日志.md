...
**待办**（阶段 B，需用户配合）：
- [ ] 用户 fork tianrking/MotorBridge → fanhao375/MotorBridge
- [ ] 用户 fork servodevelop/Star-Arm-102 → fanhao375/Star-Arm-102
- [ ] 修改 .gitmodules 指向自己的 fork
- [ ] 在每个 fork 内配置 upstream remote
- [ ] 在当前锁定的 commit 上打 baseline tag
- [ ] 单独 commit submodule URL 变更
