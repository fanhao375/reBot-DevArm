...
> ⚠️ 中英文 README 状态标记不一致，以中文版为准（官方主要文档）；英文版在 2026-04-23 把 LeRobot 和视觉抓取都标成 ✅ Completed，但：
> - LeRobot 官方 wiki 仍是"即将发布"
> - 视觉抓取 Demo wiki 链接（中英文）均 404
> 所以不要把英文 README 的 ✅ 当成"已经可用"。
...
| 深度相机视觉抓取 Demo | 🚧 路线图已列（README 加了链接，但 wiki 页面 404，疑似抢发） |
| ROS2 + MoveIt2 | 🚧 进行中（核心驱动已完成，MoveIt2 优化中） |
| Isaac Sim 仿真 | 🚧 进行中 |
| LeRobot AI 训练 | 🚧 进行中（英文 README 标 ✅ 但 wiki 未上线，以中文版 🚧 为准） |
| RS 版硬件 | 🚧 预计 05 月 |
