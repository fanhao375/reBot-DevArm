...
|-----------|---------|--------------------|------|
| `software/MotorBridge` | [tianrking/MotorBridge](https://github.com/tianrking/MotorBridge) | [tianrking/MotorBridge](https://github.com/tianrking/MotorBridge) `main` | 底层电机控制库；⏳ **待 fork 到 fanhao375** |
