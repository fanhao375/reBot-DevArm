...
|-----------|---------|--------------------|------|
| `software/MotorBridge` | [motorbridge/motorbridge](https://github.com/motorbridge/motorbridge) | [tianrking/MotorBridge](https://github.com/tianrking/MotorBridge) `main`（旧地址，自动重定向到新组织） | 底层电机控制库；⏳ **待 fork 到 fanhao375 + 切到新地址** |
...
| `遥操作/StarArm_102` | [servodevelop/Star-Arm-102](https://github.com/servodevelop/Star-Arm-102) | [servodevelop/Star-Arm-102](https://github.com/servodevelop/Star-Arm-102) `main` | 主动臂控制库；⏳ **待 fork 到 fanhao375** |
